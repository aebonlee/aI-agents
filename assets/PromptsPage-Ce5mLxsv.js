...
- A4 2-3 page length`}]}};function l(){let{language:e,t}=r(),[n,l]=(0,a.useState)(`research`),[u,d]=(0,a.useState)(null),f=e===`ko`,p=c[n],m=(0,a.useCallback)((e,t)=>{navigator.clipboard.writeText(e).then(()=>{d(t),setTimeout(()=>d(null),2e3)})},[]);return(0,o.jsxs)(`div`,{className:`content-page`,children:[(0,o.jsx)(i,{title:t(`prompts.title`),description:t(`prompts.subtitle`),path:`/prompts`}),(0,o.jsx)(`div`,{className:`page-header`,children:(0,o.jsxs)(`div`,{className:`container`,children:[(0,o.jsx)(`h1`,{children:t(`prompts.title`)}),(0,o.jsx)(`p`,{className:`page-desc`,children:t(`prompts.subtitle`)})]})}),(0,o.jsx)(`div`,{className:`container`,children:(0,o.jsxs)(`div`,{className:`content-page-layout`,children:[(0,o.jsxs)(`aside`,{className:`content-sidebar`,children:[(0,o.jsx)(`h3`,{children:f?`템플릿 유형`:`Template Types`}),(0,o.jsx)(`ul`,{className:`sidebar-nav`,children:s.map(e=>(0,o.jsx)(`li`,{className:`sidebar-nav-item`,children:(0,o.jsxs)(`button`,{className:`sidebar-nav-btn ${n===e.id?`active`:``}`,onClick:()=>l(e.id),children:[(0,o.jsx)(`i`,{className:`fa-solid ${e.icon}`,"aria-hidden":`true`,style:{marginRight:`8px`,width:`16px`}}),f?e.titleKo:e.titleEn]})},e.id))})]}),(0,o.jsx)(`div`,{className:`content-main`,children:(0,o.jsxs)(`div`,{className:`content-card`,children:[(0,o.jsx)(`h2`,{children:f?p.titleKo:p.titleEn}),(0,o.jsx)(`p`,{children:f?p.descKo:p.descEn}),p.examples.map((e,t)=>{let r=f?e.promptKo:e.promptEn,i=`${n}-${t}`,a=u===i;return(0,o.jsxs)(`div`,{style:{marginTop:t>0?`32px`:`20px`},children:[(0,o.jsxs)(`h3`,{children:[(0,o.jsx)(`i`,{className:`fa-solid fa-code`,"aria-hidden":`true`,style:{marginRight:`8px`}}),f?e.titleKo:e.titleEn]}),(0,o.jsxs)(`div`,{className:`example-box`,children:[(0,o.jsxs)(`div`,{className:`example-box-header`,children:[(0,o.jsx)(`h4`,{children:f?`프롬프트 템플릿`:`Prompt Template`}),(0,o.jsxs)(`button`,{className:`copy-btn ${a?`copied`:``}`,onClick:()=>m(r,i),"aria-label":f?`복사`:`Copy`,children:[(0,o.jsx)(`i`,{className:`fa-solid ${a?`fa-check`:`fa-copy`}`,"aria-hidden":`true`}),(0,o.jsx)(`span`,{children:a?f?`복사됨`:`Copied`:f?`복사`:`Copy`})]})]}),(0,o.jsx)(`pre`,{children:r})]})]},t)}),(0,o.jsxs)(`div`,{className:`info-box tip`,style:{marginTop:`24px`},children:[(0,o.jsx)(`h4`,{children:f?`활용 팁`:`Usage Tips`}),(0,o.jsx)(`p`,{children:f?`- 대괄호 [ ] 안의 내용을 자신의 업무 상황에 맞게 수정하세요`:`- Modify content in brackets [ ] to match your work context`}),(0,o.jsx)(`p`,{children:f?`- 역할 부여 → 맥락 설정 → 구체적 지시 → 출력 형식 순서로 프롬프트를 구성하면 효과적입니다`:`- Structure prompts in order: role assignment → context setting → specific instructions → output format`}),(0,o.jsx)(`p`,{children:f?`- 결과가 만족스럽지 않으면 조건을 추가하거나 구체화하여 다시 요청하세요`:`- If results are unsatisfactory, add conditions or be more specific and try again`})]})]})})]})})]})}export{l as default};