import{n as e}from"./rolldown-runtime-DF2fYuay.js";import{d as t,t as n}from"./vendor-DCezTRfP.js";import{n as r}from"./LanguageContext-DXG3lZeB.js";import{t as i}from"./SEOHead-C1vRTg_6.js";var a=e(t(),1),o=n(),s=[{id:`research`,titleKo:`리서치 결과 예시`,titleEn:`Research Results`,icon:`fa-magnifying-glass-chart`},{id:`ax-idea`,titleKo:`AX 아이디어 예시`,titleEn:`AX Idea Examples`,icon:`fa-lightbulb`},{id:`agent-design`,titleKo:`Agent 설계 예시`,titleEn:`Agent Design Examples`,icon:`fa-robot`},{id:`action-plan`,titleKo:`실행안 예시`,titleEn:`Action Plan Examples`,icon:`fa-clipboard-list`},{id:`presentation`,titleKo:`발표자료 예시`,titleEn:`Presentation Examples`,icon:`fa-file-powerpoint`}],c={research:[{titleKo:`발전산업 AI 도입 현황 리서치 결과`,titleEn:`Power Industry AI Adoption Status Research`,descKo:`국내외 발전사의 AI 도입 현황을 Perplexity와 Genspark을 활용하여 조사한 결과물입니다. 기술 동향, 적용 분야, 성과 지표를 구조화하여 정리하였습니다.`,descEn:`Research results on AI adoption status of domestic and international power companies using Perplexity and Genspark. Structured technology trends, application areas, and performance metrics.`,contentKo:`[조사 개요]
...
- 비정형 업무(문서, 소통)의 AI 적용이 다음 성장 영역`,contentEn:`[Research Overview]
...
- AI application for unstructured work (documents, communication) is the next growth area`},{titleKo:`공공기관 AI 활용 정책 동향 리서치`,titleEn:`Public Sector AI Policy Trend Research`,descKo:`정부의 AI 관련 정책, 공공부문 디지털 전환 전략, 공공기관 AI 도입 가이드라인을 조사하고 정리한 결과물입니다.`,descEn:`Research results on government AI policies, public sector digital transformation strategies, and public institution AI adoption guidelines.`,contentKo:`[핵심 정책 동향]
1. 디지털 플랫폼 정부 추진
   - 공공서비스 AI 기반 혁신 가속화
   - 범정부 AI 활용 가이드라인 수립
2. 공공기관 AI 역량 강화
...
3. 데이터 기반 행정 강화
   - 공공데이터 개방 확대
   - AI 기반 데이터 분석 인프라 구축`,contentEn:`[Key Policy Trends]
...
3. Data-Based Administration Enhancement
   ...
   - Building AI-based data analysis infrastructure`}],"ax-idea":[{titleKo:`발전소 안전관리 AI Agent 아이디어`,titleEn:`Power Plant Safety Management AI Agent Idea`,descKo:`발전소의 안전관리 업무에 AI Agent를 적용하여 안전점검 보고서 자동 생성, 위험 요인 사전 식별, 안전 교육 콘텐츠 자동화를 구현하는 아이디어입니다.`,descEn:`An idea to apply AI Agent to power plant safety management for auto-generating safety inspection reports, proactive risk identification, and safety training content automation.`,contentKo:`[아이디어 개요]
...
3. 법규 변경 → AI 요약 → 교육자료 자동 업데이트`,contentEn:`[Idea Overview]
...
3. Regulation changes → AI summary → Auto-update training materials`},{titleKo:`공공기관 민원 응대 AI Agent 아이디어`,titleEn:`Public Institution Civil Service AI Agent Idea`,descKo:`공공기관의 민원 응대 업무를 AI Agent로 지원하여 초기 분류, FAQ 자동응답, 답변 초안 작성을 자동화하는 아이디어입니다.`,descEn:`An idea to support public institution civil service with AI Agent for initial categorization, FAQ auto-response, and draft reply generation.`,contentKo:`[아이디어 개요]
...
3. 복잡 민원 → AI 답변 초안 생성 → 담당자 검토 후 발송`,contentEn:`[Idea Overview]
...
3. Complex complaints → AI draft reply → Staff review and send`}],"agent-design":[{titleKo:`회의자료 자동작성 Agent 설계서`,titleEn:`Meeting Document Auto-Writer Agent Design`,descKo:`주간 업무 보고, 팀 회의, 경영회의 등에 필요한 회의자료를 자동으로 작성하는 AI Agent의 설계서 예시입니다.`,descEn:`Design document example for an AI Agent that automatically creates meeting materials for weekly reports, team meetings, and management meetings.`,contentKo:`[Agent 설계 캔버스]
...
5. 최종 문서 출력`,contentEn:`[Agent Design Canvas]
...
5. Output final document`},{titleKo:`리서치 자동화 Agent 설계서`,titleEn:`Research Automation Agent Design`,descKo:`산업 동향, 경쟁사 분석 등의 리서치 업무를 자동화하는 AI Agent 설계서 예시입니다.`,descEn:`Design document example for an AI Agent that automates research tasks such as industry trends and competitor analysis.`,contentKo:`[Agent 설계 캔버스]
...
7. 최종 보고서 출력`,contentEn:`[Agent Design Canvas]
...
7. Output final report`}],"action-plan":[{titleKo:`사내 AI Agent 도입 실행 계획서`,titleEn:`Internal AI Agent Implementation Plan`,descKo:`사내 업무에 AI Agent를 도입하기 위한 3개월 시범 운영 실행 계획서 예시입니다.`,descEn:`Example 3-month pilot implementation plan for introducing AI Agents to internal operations.`,contentKo:`[프로젝트 개요]
...
- 회의자료 작성 시간 50% 이상 단축
- 사용자 만족도 4.0/5.0 이상
- 월 20건 이상 Agent 활용`,contentEn:`[Project Overview]
...
- 20+ Agent utilizations per month`},{titleKo:`부서 AI 역량 강화 교육 계획서`,titleEn:`Department AI Capability Training Plan`,descKo:`부서 구성원의 AI 활용 역량을 단계적으로 강화하기 위한 6개월 교육 실행 계획서 예시입니다.`,descEn:`Example 6-month training plan for progressively strengthening department members' AI utilization capabilities.`,contentKo:`[계획 개요]
...
- 분기별 만족도 조사`,contentEn:`[Plan Overview]
...
- Quarterly satisfaction survey`}],presentation:[{titleKo:`팀 발표자료 예시 (AI Agent 기반 업무혁신)`,titleEn:`Team Presentation Example (AI Agent Work Innovation)`,descKo:`교육 마지막 세션에서 팀별로 발표하는 결과 발표자료의 예시 구성입니다.`,descEn:`Example structure of team presentation materials for the final education session.`,contentKo:`[발표자료 구성 (12슬라이드)]
...
슬라이드 12: Q&A
- 핵심 메시지 정리
- 질의응답`,contentEn:`[Presentation Structure (12 Slides)]
...
Slide 12: Q&A
- Key message summary
- Questions and answers`},{titleKo:`AX 추진 경영보고 발표자료 예시`,titleEn:`AX Initiative Executive Report Presentation`,descKo:`부서 또는 기관 차원의 AX(AI Transformation) 추진 현황을 경영진에게 보고하는 발표자료 구성 예시입니다.`,descEn:`Example presentation structure for reporting AX (AI Transformation) progress to executives at department or institutional level.`,contentKo:`[발표자료 구성 (8슬라이드)]
...
슬라이드 8: 건의 사항
- 경영진 의사결정 요청 항목
- 지원 필요 사항`,contentEn:`[Presentation Structure (8 Slides)]
...
- Support requirements`}]};function l(){let{language:e,t}=r(),[n,l]=(0,a.useState)(`research`),u=e===`ko`,d=c[n]||[];return(0,o.jsxs)(`div`,{className:`content-page`,children:[(0,o.jsx)(i,{title:t(`results.title`),description:t(`results.subtitle`),path:`/results`}),(0,o.jsx)(`div`,{className:`page-header`,children:(0,o.jsxs)(`div`,{className:`container`,children:[(0,o.jsx)(`h1`,{children:t(`results.title`)}),(0,o.jsx)(`p`,{className:`page-desc`,children:t(`results.subtitle`)})]})}),(0,o.jsx)(`div`,{className:`container`,children:(0,o.jsxs)(`div`,{className:`content-page-layout`,children:[(0,o.jsxs)(`aside`,{className:`content-sidebar`,children:[(0,o.jsx)(`h3`,{children:u?`결과물 유형`:`Result Types`}),(0,o.jsx)(`ul`,{className:`sidebar-nav`,children:s.map(e=>(0,o.jsx)(`li`,{className:`sidebar-nav-item`,children:(0,o.jsxs)(`button`,{className:`sidebar-nav-btn ${n===e.id?`active`:``}`,onClick:()=>l(e.id),children:[(0,o.jsx)(`i`,{className:`fa-solid ${e.icon}`,"aria-hidden":`true`,style:{marginRight:`8px`,width:`16px`}}),u?e.titleKo:e.titleEn]})},e.id))})]}),(0,o.jsxs)(`div`,{className:`content-main`,children:[d.map((e,t)=>(0,o.jsxs)(`div`,{className:`content-card`,children:[(0,o.jsx)(`h2`,{children:u?e.titleKo:e.titleEn}),(0,o.jsx)(`p`,{children:u?e.descKo:e.descEn}),(0,o.jsxs)(`div`,{className:`example-box`,children:[(0,o.jsx)(`h4`,{children:u?`산출물 내용`:`Deliverable Content`}),(0,o.jsx)(`pre`,{children:u?e.contentKo:e.contentEn})]})]},t)),(0,o.jsxs)(`div`,{className:`info-box`,style:{marginTop:`12px`},children:[(0,o.jsx)(`h4`,{children:u?`안내`:`Note`}),(0,o.jsx)(`p`,{children:u?`위 결과물은 교육 과정에서 실제로 만들어지는 산출물의 예시입니다. 실제 교육에서는 참가자 본인의 업무를 소재로 더욱 구체적인 결과물이 생성됩니다.`:`The above are examples of deliverables actually created during the education program. In actual training, more specific deliverables are generated using participants' own work as material.`})]})]})]})})]})}export{l as default};