...
- Perplexity: Source-based fact-checking`}]}],c=[{id:`overview`,titleKo:`도구 개요`,titleEn:`Tools Overview`,icon:`fa-grid-2`},...s.map(e=>({id:e.id,titleKo:e.nameKo,titleEn:e.nameEn,icon:e.icon})),{id:`environment`,titleKo:`실습 환경 안내`,titleEn:`Practice Environment`,icon:`fa-laptop-code`}];function l(){let{language:e,t}=r(),[n,l]=(0,a.useState)(`overview`),u=e===`ko`,d=s.find(e=>e.id===n);return(0,o.jsxs)(`div`,{className:`content-page`,children:[(0,o.jsx)(i,{title:t(`tools.title`),description:t(`tools.subtitle`),path:`/tools`}),(0,o.jsx)(`div`,{className:`page-header`,children:(0,o.jsxs)(`div`,{className:`container`,children:[(0,o.jsx)(`h1`,{children:t(`tools.title`)}),(0,o.jsx)(`p`,{className:`page-desc`,children:t(`tools.subtitle`)})]})}),(0,o.jsx)(`div`,{className:`container`,children:(0,o.jsxs)(`div`,{className:`content-page-layout`,children:[(0,o.jsxs)(`aside`,{className:`content-sidebar`,children:[(0,o.jsx)(`h3`,{children:u?`목차`:`Contents`}),(0,o.jsx)(`ul`,{className:`sidebar-nav`,children:c.map(e=>(0,o.jsx)(`li`,{className:`sidebar-nav-item`,children:(0,o.jsxs)(`button`,{className:`sidebar-nav-btn ${n===e.id?`active`:``}`,onClick:()=>l(e.id),children:[(0,o.jsx)(`i`,{className:`fa-solid ${e.icon}`,"aria-hidden":`true`}),` `,u?e.titleKo:e.titleEn]})},e.id))})]}),(0,o.jsxs)(`div`,{className:`content-main`,children:[n===`overview`&&(0,o.jsxs)(`div`,{className:`content-card`,children:[(0,o.jsx)(`h2`,{children:u?`도구 개요`:`Tools Overview`}),(0,o.jsx)(`p`,{children:u?`교육 과정에서 활용하는 6개의 핵심 AI 도구입니다. 각 도구를 클릭하면 상세 정보, 외부 링크, 주요 기능, 유용한 팁, 활용 프롬프트를 확인할 수 있습니다.`:`These are the 6 core AI tools used in the education program. Click each tool for detailed information, external links, key features, useful tips, and practice prompts.`}),(0,o.jsx)(`div`,{className:`tools-grid`,children:s.map(e=>(0,o.jsxs)(`div`,{className:`tool-card`,style:{cursor:`pointer`,borderTopColor:e.color},onClick:()=>l(e.id),role:`button`,tabIndex:0,onKeyDown:t=>{t.key===`Enter`&&l(e.id)},children:[(0,o.jsxs)(`div`,{className:`tool-card-header`,children:[(0,o.jsx)(`div`,{className:`tool-icon`,style:{background:`${e.color}15`,color:e.color},children:(0,o.jsx)(`i`,{className:`fa-solid ${e.icon}`,"aria-hidden":`true`})}),(0,o.jsxs)(`div`,{className:`tool-name-group`,children:[(0,o.jsx)(`h3`,{children:u?e.nameKo:e.nameEn}),(0,o.jsx)(`span`,{className:`tool-category`,children:u?e.categoryKo:e.categoryEn})]})]}),(0,o.jsx)(`p`,{className:`tool-desc`,children:u?e.descKo:e.descEn})]},e.id))})]}),d&&(0,o.jsxs)(`div`,{className:`content-card`,children:[(0,o.jsxs)(`h2`,{children:[(0,o.jsx)(`i`,{className:`fa-solid ${d.icon}`,"aria-hidden":`true`,style:{color:d.color,marginRight:`10px`}}),u?d.nameKo:d.nameEn]}),(0,o.jsxs)(`p`,{style:{marginBottom:`4px`},children:[(0,o.jsxs)(`strong`,{children:[u?`카테고리`:`Category`,`:`]}),` `,u?d.categoryKo:d.categoryEn]}),(0,o.jsx)(`p`,{children:u?d.descKo:d.descEn}),(0,o.jsxs)(`a`,{href:d.url,target:`_blank`,rel:`noopener noreferrer`,className:`tool-external-link`,children:[(0,o.jsx)(`i`,{className:`fa-solid fa-arrow-up-right-from-square`,"aria-hidden":`true`}),d.url]}),(0,o.jsx)(`h3`,{children:u?`주요 기능`:`Key Features`}),(0,o.jsx)(`div`,{className:`framework-grid`,children:(u?d.featuresKo:d.featuresEn).map((e,t)=>{let n=[`#1B3A6B`,`#2E86AB`,`#A23B72`,`#F18F01`,`#00855A`];return(0,o.jsxs)(`div`,{className:`framework-item`,style:{borderLeft:`3px solid ${n[t%n.length]}`},children:[(0,o.jsx)(`h4`,{children:u?`기능 ${t+1}`:`Feature ${t+1}`}),(0,o.jsx)(`p`,{children:e})]},t)})}),(0,o.jsx)(`h3`,{children:u?`유용한 팁`:`Useful Tips`}),(0,o.jsxs)(`div`,{className:`info-box tip`,children:[(0,o.jsxs)(`h4`,{children:[(0,o.jsx)(`i`,{className:`fa-solid fa-lightbulb`,"aria-hidden":`true`}),` `,u?`실습 팁`:`Practice Tips`]}),(0,o.jsx)(`ul`,{children:(u?d.tipsKo:d.tipsEn).map((e,t)=>(0,o.jsx)(`li`,{style:{marginBottom:`8px`,fontSize:`14px`,lineHeight:`1.7`},children:e},t))})]}),(0,o.jsx)(`h3`,{children:u?`활용 사례 및 프롬프트`:`Use Cases & Prompts`}),(u?d.promptsKo:d.promptsEn).map((e,t)=>(0,o.jsxs)(`div`,{className:`example-box`,children:[(0,o.jsx)(`div`,{className:`example-label`,children:e.title}),(0,o.jsx)(`pre`,{children:e.prompt})]},t))]}),n===`environment`&&(0,o.jsxs)(`div`,{className:`content-card`,children:[(0,o.jsx)(`h2`,{children:u?`실습 환경 안내`:`Practice Environment Guide`}),(0,o.jsx)(`p`,{children:u?`교육 참가자는 아래 환경을 사전에 준비해 주시기 바랍니다.`:`Please prepare the following environment before the training.`}),(0,o.jsxs)(`div`,{className:`framework-grid`,children:[(0,o.jsxs)(`div`,{className:`framework-item`,style:{borderLeft:`3px solid #1B3A6B`},children:[(0,o.jsxs)(`h4`,{children:[(0,o.jsx)(`i`,{className:`fa-solid fa-laptop`,"aria-hidden":`true`}),` `,u?`노트북`:`Laptop`]}),(0,o.jsx)(`p`,{children:u?`인터넷 접속 가능한 노트북 (Windows/Mac 무관)`:`Internet-connected laptop (Windows/Mac)`})]}),(0,o.jsxs)(`div`,{className:`framework-item`,style:{borderLeft:`3px solid #3D6DB5`},children:[(0,o.jsxs)(`h4`,{children:[(0,o.jsx)(`i`,{className:`fa-solid fa-user-plus`,"aria-hidden":`true`}),` `,u?`계정 준비`:`Account Setup`]}),(0,o.jsx)(`p`,{children:u?`ChatGPT, Claude 무료 계정 (사전 가입 권장)`:`ChatGPT, Claude free accounts (pre-registration recommended)`})]}),(0,o.jsxs)(`div`,{className:`framework-item`,style:{borderLeft:`3px solid #00855A`},children:[(0,o.jsxs)(`h4`,{children:[(0,o.jsx)(`i`,{className:`fa-solid fa-wifi`,"aria-hidden":`true`}),` `,u?`네트워크`:`Network`]}),(0,o.jsx)(`p`,{children:u?`안정적인 인터넷 접속 환경 (Wi-Fi 제공)`:`Stable internet connection (Wi-Fi provided)`})]}),(0,o.jsxs)(`div`,{className:`framework-item`,style:{borderLeft:`3px solid #C87200`},children:[(0,o.jsxs)(`h4`,{children:[(0,o.jsx)(`i`,{className:`fa-solid fa-browser`,"aria-hidden":`true`}),` `,u?`브라우저`:`Browser`]}),(0,o.jsx)(`p`,{children:u?`Chrome 또는 Edge 최신 버전 권장`:`Latest Chrome or Edge recommended`})]})]}),(0,o.jsx)(`h3`,{children:u?`도구별 바로가기`:`Quick Links`}),(0,o.jsx)(`div`,{className:`framework-grid`,children:s.map(e=>(0,o.jsxs)(`div`,{className:`framework-item`,children:[(0,o.jsxs)(`h4`,{children:[(0,o.jsx)(`i`,{className:`fa-solid ${e.icon}`,"aria-hidden":`true`,style:{color:e.color}}),` `,u?e.nameKo:e.nameEn]}),(0,o.jsx)(`p`,{children:(0,o.jsxs)(`a`,{href:e.url,target:`_blank`,rel:`noopener noreferrer`,style:{color:`var(--primary-blue)`,textDecoration:`none`},children:[e.url,` `,(0,o.jsx)(`i`,{className:`fa-solid fa-arrow-up-right-from-square`,"aria-hidden":`true`,style:{fontSize:`11px`}})]})})]},e.id))})]})]})]})})]})}export{l as default};