...
const CASES = [
  ...
  },
  {
    ...
    category: 'university',
    titleKo: '대학원 연구 지원 AI Agent 활용 사례',
    titleEn: 'Graduate Research Support AI Agent Case',
    descKo: '대학원 연구실에서 논문 리서치, 선행연구 분석, 연구 데이터 정리에 AI Agent를 체계적으로 활용한 사례입니다. Perplexity를 활용한 출처 기반 문헌 조사와 Claude를 활용한 논문 구조화 방법론을 적용하였습니다.',
    descEn: 'A case of systematically using AI Agents for paper research, prior study analysis, and research data organization in graduate labs. Applied source-based literature review using Perplexity and paper structuring methodology using Claude.',
    tagsKo: ['연구 지원', '논문 리서치', '문헌 분석'],
    tagsEn: ['Research Support', 'Paper Research', 'Literature Analysis'],
    icon: 'fa-flask',
  },
  {
    id: 'university-capstone',
    category: 'university',
    titleKo: '캡스톤 디자인 프로젝트 AI Agent 적용 사례',
    titleEn: 'Capstone Design Project AI Agent Application',
    descKo: '공학계열 캡스톤 디자인 과정에서 학생 팀이 AI Agent를 활용하여 프로젝트 기획, 시장조사, 프로토타입 설계를 수행한 사례입니다. 비전공 학생도 AI를 통해 기술 리서치와 사업계획서 작성이 가능함을 입증하였습니다.',
    descEn: 'A case where student teams used AI Agents for project planning, market research, and prototype design in engineering capstone courses. Demonstrated that non-technical students can conduct tech research and write business plans through AI.',
    tagsKo: ['캡스톤 디자인', '프로젝트 기획', '학생 팀'],
    tagsEn: ['Capstone Design', 'Project Planning', 'Student Teams'],
  ...
  },
  {
    id: 'enterprise-cs',
    category: 'enterprise',
    titleKo: '고객응대 매뉴얼 자동화 및 CS 품질 향상 사례',
    titleEn: 'Customer Service Manual Automation & Quality Improvement',
    descKo: '고객센터 운영 기업에서 AI Agent를 활용하여 CS 응대 매뉴얼을 자동 생성하고, 상담 품질 분석 및 개선 보고서를 자동화한 사례입니다. 상담원 교육 시간 단축과 응대 일관성 향상 효과를 달성하였습니다.',
    descEn: 'A case where a customer center company used AI Agents to auto-generate CS response manuals and automate quality analysis and improvement reports. Achieved reduced agent training time and improved response consistency.',
    tagsKo: ['고객응대', 'CS 품질', '매뉴얼 자동화'],
    tagsEn: ['Customer Service', 'CS Quality', 'Manual Automation'],
    icon: 'fa-headset',
  },
  {
    id: 'enterprise-marketing',
    category: 'enterprise',
    titleKo: '마케팅 콘텐츠 기획 및 제작 자동화 사례',
    titleEn: 'Marketing Content Planning & Production Automation',
    descKo: '중견기업 마케팅팀에서 AI Agent를 활용하여 시장 트렌드 리서치, 콘텐츠 기획안 작성, SNS 포스팅 초안 생성을 자동화한 사례입니���. 월간 콘텐츠 생산량 3배 증가, 기획 소요 시간 60% 절감을 달성하였습니다.',
    descEn: 'A case where a mid-size company marketing team automated market trend research, content planning, and SNS post drafting using AI Agents. Achieved 3x monthly content output and 60% reduction in planning time.',
    tagsKo: ['마케팅', '콘텐츠 자동화', '생산성 향상'],
    tagsEn: ['Marketing', 'Content Automation', 'Productivity'],
    icon: 'fa-bullhorn',
  },
  {
